(function($) {
    ...
    var dropdownBtn = document.querySelector(".cs-dropdown-btn");
    var dropdownContent = document.querySelector(".cs-dropdown-content");
    ...
    dropdownOptions.forEach(function(option) {
        option.addEventListener("click", function() {
            ...
            // set the dropdown button's text to the selected option
    ...
    window.addEventListener("click", function(event) {
        if (!event.target.matches(".cs-dropdown-btn")) {
            dropdownContent.classList.remove("show");
        }
    });
    // Replace 'API_URL' with the URL of the API that returns the number of NFTs minted
    fetch('API_URL')
        .then(response => response.json())
        .then(data => {
            const nftMinted = data.totalMinted;
            document.getElementById('nft-minted').textContent = nftMinted;
        })
